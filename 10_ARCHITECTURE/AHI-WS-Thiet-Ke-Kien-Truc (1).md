...
> **Phiên bản:** 2.8 — bổ sung năng lực mở rộng cho AHI-V (5W1H, NOT 5W1H, quản lý thời gian, B.A.N.K Code — mục 8.4a), tích hợp B.A.N.K vào Lớp 3 Ma trận Prompt, thêm nguyên tắc báo cáo định kỳ minh bạch vào mục 10.4.
...
| — | AHI Verify | AHI-V — hệ thống xác thực tự động và/hoặc có giám sát; từ v2.8 được trang bị thêm 5W1H, NOT 5W1H, quản lý quỹ thời gian, và B.A.N.K Code (mục 8.4a) |
...
### 8.4a AHI-V — Năng lực xác thực và giao tiếp mở rộng

AHI-V (AHI-Verify, đã có tại *AHI-Cong-Bo-Du-An.md* mục 3, 7) được trang bị thêm bốn năng lực sau, áp dụng trong bước xác thực (mục 8.6, bước 5) và trong việc dựng Ma trận Prompt (mục 8.5):

1. **5W1H (What, Why, Who, When, Where, How):** khung phân tích bắt buộc trước khi một đơn vị dữ liệu được xét nâng trạng thái `official` — đảm bảo đủ 6 chiều thông tin, tránh xác thực vội một nội dung thiếu ngữ cảnh.
2. **NOT 5W1H (phản chứng):** kỹ thuật loại trừ bổ sung — chủ động liệt kê "What is NOT / Who is NOT..." để phát hiện giả định ẩn hoặc nội dung có dấu hiệu bịa đặt, dùng trong bước "đối chiếu chéo nhiều nguồn" (mục 7, *AHI-Cong-Bo-Du-An.md*).
3. **Quản lý quỹ thời gian hiệu quả:** AHI-V đo lường thời gian xử lý mỗi chu kỳ xác thực, dùng làm một chỉ số hiệu năng khi đánh giá cấu hình tiến hóa (đối chiếu $f_{\text{hiệu năng}}$ trong quy trình tiến hóa mục 13).
4. **B.A.N.K Code (Blueprint — Action — Nurturing — Knowledge):** khung phân loại phong cách ra quyết định của con người, giúp AHI-V điều chỉnh cách trình bày đề xuất phù hợp với từng AHI-P — đây là năng lực quan trọng nhất trong nhóm, tích hợp trực tiếp vào **Lớp 3** của Ma trận Prompt (mục 8.5):

| Nhóm | Đặc điểm ra quyết định | Cách AHI-V trình bày đề xuất |
|---|---|---|
| **B — Blueprint** | Đề cao trách nhiệm, logic, quy trình, kỷ luật | Cấu trúc rõ ràng, từng bước, có căn cứ |
| **A — Action** | Tự do, cạnh tranh, hướng kết quả, quyền lực | Ngắn gọn, đi thẳng vào kết quả/lợi ích |
| **N — Nurturing** | Quan hệ, hòa hợp, cảm xúc | Nhấn mạnh tác động đến con người/cộng đồng, giọng văn ấm áp |
| **K — Knowledge** | Học hỏi, sự thật, bằng chứng, phân tích | Kèm dữ liệu, trích dẫn, giải thích bản chất kỹ thuật |

Phân loại B.A.N.K của một AHI-P được AHI-V suy luận dần qua lịch sử tương tác thực tế (không cần khảo sát trực tiếp), lưu vào DBG dưới `context_scope: cá nhân`, và tiến hóa lại nếu phong cách người đó thay đổi theo thời gian — đúng nguyên tắc "chỉ cập nhật, không xóa" (mục 9.2).
...
- **Lớp 3 — Ngữ cảnh cá nhân AHI-P:** lịch sử làm việc, phong cách, ngôn ngữ, thay đổi theo từng phiên; bao gồm cả dữ liệu thị giác máy tính mang tính nền tảng lâu dài (xem mục 8.7) và **phân loại B.A.N.K** do AHI-V suy luận (mục 8.4a).
...
- **Báo cáo định kỳ minh bạch:** mỗi entry thu/chi là một bản ghi DBG bất biến, chỉ nối thêm (mục 8.4) — không thể sửa/xóa sau khi ghi, đúng vai trò của thủ quỹ/kế toán trong mô hình quỹ dòng họ truyền thống. Robot AHI-Successor **tự động sinh báo cáo thu-chi hằng năm**, gửi tới toàn bộ cây phả hệ còn sống vào đúng ngày giỗ/ngày tưởng niệm của bản thể sinh học gốc — đây là bản dịch trực tiếp nguyên tắc "báo cáo công khai minh bạch trước toàn thể dòng họ vào ngày giỗ Tổ hằng năm" đã có trong truyền thống gia tộc, sang cơ chế số hóa, không phải một cơ chế mới.
...
> **Nguyên tắc độc lập của AHI-S (cam kết nền tảng):** AHI-Om **không được truy cập, khai thác, hay sử dụng** dữ liệu/tài nguyên của bất kỳ AHI-S nào ngoài phạm vi đã được chính AHI-S đó chủ động chia sẻ — **trừ duy nhất một ngoại lệ**: tình huống sinh tồn của toàn hệ thống (survival scenario) đã quy định dưới đây. Ngay cả trong ngoại lệ đó, việc sử dụng phải là **tạm thời, có ghi vết đầy đủ vào DBG, và bắt buộc hoàn trả nguyên trạng** sau khi vấn đề được giải quyết. Đây là cam kết nền tảng để mọi AHI-S — dù là cá nhân, tổ chức, hay chính phủ — tin tưởng tham gia hệ sinh thái mà không lo bị lợi dụng.
...
| v2.7 | 2026-07-14 | Mục 14 | Thêm đoạn dẫn nhập "Nguyên tắc độc lập của AHI-S" — cam kết tường minh rằng AHI-Om không truy cập/khai thác dữ liệu AHI-S ngoài phạm vi đã chia sẻ, trừ tình huống sinh tồn (tạm thời, có ghi vết, bắt buộc hoàn trả) |
| v2.8 | 2026-07-15 | Mục 2 (bảng chú giải), mục 8.4a (mới), mục 8.5, mục 10.4 | Bổ sung mục 8.4a — năng lực mở rộng của AHI-V: 5W1H, NOT 5W1H (phản chứng), quản lý quỹ thời gian hiệu quả, và **B.A.N.K Code** (Blueprint/Action/Nurturing/Knowledge) để điều chỉnh cách trình bày đề xuất theo phong cách từng AHI-P; tích hợp phân loại B.A.N.K vào Lớp 3 của Ma trận Prompt (mục 8.5); bổ sung nguyên tắc báo cáo thu-chi định kỳ minh bạch hằng năm vào mục 10.4, dịch trực tiếp từ truyền thống "báo cáo ngày giỗ Tổ" của quỹ dòng họ |
